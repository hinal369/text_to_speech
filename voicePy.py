...
def text_to_speech_with_zira(text, save_to_file=None):
    engine = pyttsx3.init()
    ...
    # Set Zira voice
    if set_voice_zira(engine):
        print("Using Microsoft Zira Desktop voice.")
    else:
        print("Microsoft Zira Desktop voice not found. Using the default voice.")
...
if __name__ == "__main__":
    ...
    # Example text
    text_to_speech_with_zira(text, save_to_file="output.mp3")
